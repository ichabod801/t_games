...
class ProberTest(unittest.TestCase):
    ...
    def testDefectCooperate(self):
        """Test prober's response to cooperate in defect mode."""
    ...
    def testDefectDefect(self):
        """Test prober's response to defect in defect mode."""
