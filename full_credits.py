...
CREDITS_DATA = [('Interface Programming', """Craig O'Brien, Micah Page"""),
    ...
    ('Bot Design', """Robert Axelrod, B. Beaufils, R. Boyd, S. Braver, K. Deb, J. Delahaye, James Friedman,
        Roger Johnson, Reiner Knizia, S. Komorita, David Kraines, Vivian Kraines, J. P. Lorberbaum, J. Li,
        S. Mittal, J. Nachbar, Todd Neller, Craig O'Brien, Mathieu Our, Clifton Presser, Anatol Rapoport,
        J. Sheposh, R. Sugden, Gerry Tesauro"""),
